...
<head>
    ...
    <title>FloSun - flower website my orders page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>my orders</h1>
            <p>Keep track of all your purchases and stay updated on the status of your orders with ease. The "My
                Orders" section provides a <br>comprehensive view of your order history and current transactions.</p>

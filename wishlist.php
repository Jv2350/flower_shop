...
<head>
    ...
    <title>FloSun - flower website wishlist page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>wishlist</h1>
            <p>Save your favorite floral arrangements and products for later with our Wishlist feature. <br>Whether
                you’re planning for a special occasion or simply browsing, the Wishlist helps you keep track of the
                flowers you love.<br>Simply click the heart icon on any product page to add items to your Wishlist, and
                they’ll be waiting for you when you’re ready to order!</p>
                ...
                <div class="content">
                    <div class="button">
                        ...
                        <div>
                            ...
                            <button type="submit" name="delete_item" onclick="return confirm('delete this product');"><i
                    ...
                    <div class="flex">
                        ...
                        <a href="checkout.php?get_id=<?= $fetch_products['id']; ?>" class="btn"
                            style="width: 100% !important;">buy now</a>
                    </div>
                </div>
            </form>
            <?php

...
<head>
    ...
    <title>FloSun - flower website register page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>register</h1>
            <p>Join the FLoSun family and enjoy a personalized, seamless flower shopping experience! Creating an account
                gives you access to exclusive benefits and <br>faster checkout, making it easier to enjoy fresh flowers
            ...
            <div class="flex">
                ...
                <div class="col">
                    ...
                    <div class="input-field">
                        ...
                        <input type="password" name="cpass" placeholder="enter your password" maxlength="50" required
                            class="box">
                    </div>
                </div>
            </div>

...
<head>
    ...
    <title>FloSun - flower website checkout page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>checkout</h1>
            <p>You’re almost there! Complete your order in just a few simple steps and get ready to enjoy your fresh,
                beautiful flowers.</p>
    ...
    <section class="checkout">
        ...
        <div class="row">
                    ...
                    <div class="flex">
                        <div class="col">
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" name="number" placeholder="enter your number" maxlength="50"
                                    required class="box">
                            </div>
                            <div class="input-field">
                        ...
                        <div class="col">
                            <div class="input-field">
                                ...
                                <input type="text" name="flat" placeholder="e.g flat & building" maxlength="50" required
                                    class="box">
                            </div>
                            <div class="input-field">
                                <p>address line 01 <span>*</span></p>
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="city" placeholder="enter your city name" maxlength="50"
                                    required class="box">
                            </div>
                            <div class="input-field">
                                <p>country name <span>*</span></p>
                                <input type="text" name="country" placeholder="enter your city name" maxlength="50"
                                    required class="box">
                            </div>
                            <div class="input-field">
            ...
            <div class="summary">
                ...
                <div class="grand_total"><span>total amount payable :</span> $<?= $grand_total; ?>/-</div>
            </div>
        </div>
    </section>

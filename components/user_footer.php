<div class="newsletter">
    <div class="box-detail">
        ...
        <p>Stay connected with FLoSun and never miss out on our latest floral designs, special offers, and exclusive
            tips for <br>keeping your flowers fresh.Join our flower-loving community today and let us bring the beauty
            of FLoSun directly to your inbox!</p>
...
<footer>
    <div class="content">
        <div class="box">
            ...
            <p>FLoSun is your trusted local florist, dedicated to creating beautiful floral arrangements for every
                occasion. </p>
        ...
        <div class="box">
            <h3>contact us</h3>
            <p><i class="bx bxs-phone"></i>+91-2233445566</p>
            <p><i class="bx bxs-envelope"></i>niki46@gmail.com</p>
    ...
    <div class="bottom">
        <p>Thank you for u see my website</p>

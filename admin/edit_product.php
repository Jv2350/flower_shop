...
<head>
    ...
    <title>FloSun - flower website edit product page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>edit product</h1>
            <p>Easily manage your floral arrangements and keep your offerings fresh with our Edit Product feature. This
                section allows<br> you to make necessary updates to your products, ensuring that your customers have the
                most accurate and appealing information.<br>Keeping your product information current helps attract
                customers and enhances their shopping experience. Make sure your offerings are always up to date and
                appealing! </p>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="register">
                    ...
                    <div class="input-field">
                        ...
                        <select name="status" class="box">
                            <option selected value="<?= $fetch_product['status']; ?>"><?= $fetch_product['status']; ?>
                            </option>

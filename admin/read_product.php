...
<head>
    ...
    <title>FloSun - flower website read product page</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>read product</h1>
            <p>Dive into the details of our beautiful floral arrangements in the Read Product section. Each product
                page <br> provides comprehensive information to help you choose the perfect bouquet for any occasion.By
                reading the product details, you can make informed decisions<br> and select the ideal flowers that best
                express your sentiments. Start exploring our floral collection today </p>
